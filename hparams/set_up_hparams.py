...
def add_logging_args(parser):
    parser.add_argument("--log_dir", type=str, default="test/intergen/continuous")
    ...
    parser.add_argument("--steps_per_save_output", type=int, default=50)
    parser.add_argument("--visdom_port", type=int, default=9501)
