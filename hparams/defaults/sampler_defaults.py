...
class HparamsIntergen(HparamsBase):
    def __init__(self, dataset):
...
def add_sampler_args(parser):
    ...
    # parser.add_argument("--sampler", type=str, required=True, choices=["absorbing", "autoregressive", "LDA", "intergen"])
    parser.add_argument("--sampler", type=str, default='intergen')
